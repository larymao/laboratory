    ...
    public class ExcelHelperTests
    {
        ...
        public async Task ExcelOperationsTest(Orientation orientation)
        {
            ...
            try
            {
                ...
                {
                    new Foo { Id = 1, InnerFoo = new InnerFoo { Name = "Adam", Description = "test data 1", CreateTime = DateTime.Now.AddDays(-1), DeepInnerFoo = new DeepInnerFoo { InnerId = 1, InnerDescription = "inner test data 1" } } },
                    new Foo { Id = 2, InnerFoo = new InnerFoo { Name = "Bob", Description = "test data 2", CreateTime = DateTime.Now.AddDays(-2), DeepInnerFoo = new DeepInnerFoo { InnerId = 2, InnerDescription = "inner test data 2" } } },
                    new Foo { Id = 3, InnerFoo = new InnerFoo { Name = "Cindy", Description = "test data 3", CreateTime = DateTime.Now.AddDays(-3), DeepInnerFoo = new DeepInnerFoo { InnerId = 3, InnerDescription = "inner test data 3" } } },
                    new Foo { Id = 4, InnerFoo = new InnerFoo { Name = "Douglas", Description = "test data 4", CreateTime = DateTime.Now.AddDays(-4) } },
                    new Foo { Id = 5 }
                };
